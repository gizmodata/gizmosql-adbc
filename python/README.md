...
See [docs/plan.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/plan.md) for the design and
[docs/WORKPLAN.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/WORKPLAN.md) for build-out progress.
