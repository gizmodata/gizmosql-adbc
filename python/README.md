...
- Python bindings keeping the 1.x `adbc-driver-gizmosql` API
  ...
  gate ([migration guide](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/migrating-1x-to-2.md))

See [docs/plan.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/plan.md) for the design,
[docs/migrating-1x-to-2.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/migrating-1x-to-2.md) for the 1.x → 2.x
migration guide, and
[docs/quickstarts-conformance.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/quickstarts-conformance.md) plus
[docs/downstream-compat.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/downstream-compat.md) for how the
driver is validated.
...
gizmosql examples (see [docs/quickstarts-conformance.md](https://github.com/gizmodata/gizmosql-adbc/blob/main/docs/quickstarts-conformance.md)):
...
Apache License 2.0 — see [LICENSE](https://github.com/gizmodata/gizmosql-adbc/blob/main/LICENSE).
