...
//
// int GizmoSQLArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int GizmoSQLArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* GizmoSQLArrayStreamGetLastError(struct ArrowArrayStream*);
// void GizmoSQLArrayStreamRelease(struct ArrowArrayStream*);
//
// int GizmoSQLArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int GizmoSQLArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
var drv = gizmosql.NewDriver(mallocator.NewMallocator())
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	err.release = (*[0]byte)(C.GizmoSQL_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_GizmoSQLError, C.size_t(1))
	cErr := (*C.struct_GizmoSQLError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.GizmoSQLReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "GizmoSQL driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in GizmoSQL driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("GizmoSQL does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "GizmoSQL: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.GizmoSQLerrRelease(cStream.adbcErr)
		} else {
...
//export GizmoSQLArrayStreamGetLastError
func GizmoSQLArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.GizmoSQLArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export GizmoSQLArrayStreamGetNext
func GizmoSQLArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.GizmoSQLArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export GizmoSQLArrayStreamGetSchema
func GizmoSQLArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.GizmoSQLArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export GizmoSQLArrayStreamRelease
func GizmoSQLArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.GizmoSQLArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export GizmoSQLErrorFromArrayStream
func GizmoSQLErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.GizmoSQLArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.GizmoSQLArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.GizmoSQLArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.GizmoSQLArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.GizmoSQLArrayStreamRelease)
...
//export GizmoSQLDatabaseGetOption
func GizmoSQLDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseGetOptionBytes
func GizmoSQLDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseGetOptionDouble
func GizmoSQLDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseGetOptionInt
func GizmoSQLDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseInit
func GizmoSQLDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseNew
func GizmoSQLDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseRelease
func GizmoSQLDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export GizmoSQLDatabaseSetOption
func GizmoSQLDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseSetOptionBytes
func GizmoSQLDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseSetOptionDouble
func GizmoSQLDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLDatabaseSetOptionInt
func GizmoSQLDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetOption
func GizmoSQLConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetOptionBytes
func GizmoSQLConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetOptionDouble
func GizmoSQLConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetOptionInt
func GizmoSQLConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionNew
func GizmoSQLConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionSetOption
func GizmoSQLConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionSetOptionBytes
func GizmoSQLConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionSetOptionDouble
func GizmoSQLConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionSetOptionInt
func GizmoSQLConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionInit
func GizmoSQLConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionRelease
func GizmoSQLConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionCancel
func GizmoSQLConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetInfo
func GizmoSQLConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetObjects
func GizmoSQLConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export GizmoSQLConnectionGetStatistics
func GizmoSQLConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetStatisticNames
func GizmoSQLConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export GizmoSQLConnectionGetTableSchema
func GizmoSQLConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionGetTableTypes
func GizmoSQLConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionReadPartition
func GizmoSQLConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionCommit
func GizmoSQLConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLConnectionRollback
func GizmoSQLConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementGetOption
func GizmoSQLStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementGetOptionBytes
func GizmoSQLStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementGetOptionDouble
func GizmoSQLStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementGetOptionInt
func GizmoSQLStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementNew
func GizmoSQLStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementRelease
func GizmoSQLStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementCancel
func GizmoSQLStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementPrepare
func GizmoSQLStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementExecuteQuery
func GizmoSQLStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementExecuteSchema
func GizmoSQLStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export GizmoSQLStatementSetSqlQuery
func GizmoSQLStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementSetSubstraitPlan
func GizmoSQLStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementBind
func GizmoSQLStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementBindStream
func GizmoSQLStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementGetParameterSchema
func GizmoSQLStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementSetOption
func GizmoSQLStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementSetOptionBytes
func GizmoSQLStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementSetOptionDouble
func GizmoSQLStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementSetOptionInt
func GizmoSQLStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export GizmoSQLStatementExecutePartitions
func GizmoSQLStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
func AdbcDriverGizmoSQLInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.GizmoSQLDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.GizmoSQLDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.GizmoSQLDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.GizmoSQLDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.GizmoSQLConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.GizmoSQLConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.GizmoSQLConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.GizmoSQLConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.GizmoSQLConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.GizmoSQLConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.GizmoSQLConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.GizmoSQLConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.GizmoSQLConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.GizmoSQLConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.GizmoSQLConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.GizmoSQLStatementNew)
	driver.StatementRelease = (*[0]byte)(C.GizmoSQLStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.GizmoSQLStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.GizmoSQLStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.GizmoSQLStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.GizmoSQLStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.GizmoSQLStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.GizmoSQLStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.GizmoSQLStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.GizmoSQLStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.GizmoSQLStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.GizmoSQLErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.GizmoSQLErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.GizmoSQLErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.GizmoSQLDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.GizmoSQLDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.GizmoSQLDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.GizmoSQLDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.GizmoSQLDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.GizmoSQLDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.GizmoSQLDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.GizmoSQLConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.GizmoSQLConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.GizmoSQLConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.GizmoSQLConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.GizmoSQLConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.GizmoSQLConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.GizmoSQLConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.GizmoSQLConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.GizmoSQLConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.GizmoSQLConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.GizmoSQLStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.GizmoSQLStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.GizmoSQLStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.GizmoSQLStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.GizmoSQLStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.GizmoSQLStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.GizmoSQLStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.GizmoSQLStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.GizmoSQLStatementSetOptionInt)
	}
